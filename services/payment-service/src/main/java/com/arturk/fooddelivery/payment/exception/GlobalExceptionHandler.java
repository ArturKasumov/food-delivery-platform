...
public class GlobalExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    @ExceptionHandler(TechnicalPaymentAppException.class)
    public ResponseEntity<ErrorResponse> handleException(TechnicalPaymentAppException exception) {
    ...
    @ExceptionHandler(BusinessPaymentAppException.class)
    public ResponseEntity<ErrorResponse> handleException(BusinessPaymentAppException exception) {
